...
data class DungeonState(
    private val playerSessionsByPlayerId: Map<String, PlayerSession> = mapOf(),
    ...
    fun getPlayerSessionById(playerId: String): PlayerSession = playerSessionsByPlayerId.getValue(playerId)
